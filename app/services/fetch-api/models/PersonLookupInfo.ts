...
export function PersonLookupInfoFromJSON(json: any): PersonLookupInfo {
    return PersonLookupInfoFromJSONTyped(json, false);
}

export function PersonLookupInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): PersonLookupInfo {
...
export function PersonLookupInfoToJSON(value?: PersonLookupInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
