...
export function ItemFieldsFromJSON(json: any): ItemFields {
    return ItemFieldsFromJSONTyped(json, false);
}

export function ItemFieldsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ItemFields {
    return json as ItemFields;
}

export function ItemFieldsToJSON(value?: ItemFields | null): any {
    return value as any;
}
