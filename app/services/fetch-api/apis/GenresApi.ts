...
export class GenresApi extends runtime.BaseAPI {
     ...
     */
    async getGenreRaw(requestParameters: GetGenreRequest): Promise<runtime.ApiResponse<BaseItemDto>> {
     ...
     * Gets a genre, by name.
     */
    async getGenre(requestParameters: GetGenreRequest): Promise<BaseItemDto> {
        const response = await this.getGenreRaw(requestParameters);
     ...
     */
    async getGenresRaw(requestParameters: GetGenresRequest): Promise<runtime.ApiResponse<BaseItemDtoQueryResult>> {
        const queryParameters: any = {};
     ...
     * Gets all genres from a given item, folder, or the entire library.
     */
    async getGenres(requestParameters: GetGenresRequest): Promise<BaseItemDtoQueryResult> {
        const response = await this.getGenresRaw(requestParameters);
        return await response.value();
    }
