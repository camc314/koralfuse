      ...
      <View>
        ...
        >
          ...
          >
            ...
            >{`Season ${this.state.selectedEpisode.parentIndexNumber} Episode ${this.state.selectedEpisode.indexNumber} • ${this.state.selectedEpisode.officialRating}`}</Text>
            <Text
              style={{
                color: this.props.colors.text,
                maxWidth: '100%',
